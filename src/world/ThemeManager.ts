...
const themes: Record<ThemeId, ThemePalette> = {
  sunset_ocean: {
    id: 'sunset_ocean',
    zenith: new THREE.Color('#2a1a4a'),
    horizon: new THREE.Color('#ff7a59'),
    ground: new THREE.Color('#0c1a2a'),
    fog: new THREE.Color('#1a1430'),
    wave: new THREE.Color('#1e3a5f'),
    foam: new THREE.Color('#ffb48a'),
  ...
  aurora_canyon: {
    id: 'aurora_canyon',
    zenith: new THREE.Color('#061018'),
    horizon: new THREE.Color('#2cff9e'),
    ground: new THREE.Color('#050810'),
    fog: new THREE.Color('#0a1820'),
    wave: new THREE.Color('#123a44'),
    foam: new THREE.Color('#7dffc8'),
  ...
  neon_tunnel: {
    id: 'neon_tunnel',
    zenith: new THREE.Color('#120018'),
    horizon: new THREE.Color('#ff2fb2'),
    ground: new THREE.Color('#08000f'),
    fog: new THREE.Color('#1a0828'),
    wave: new THREE.Color('#2a0a44'),
    foam: new THREE.Color('#ff6bff'),
